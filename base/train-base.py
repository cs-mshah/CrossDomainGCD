...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        wandb.log({'acc-known':test_acc_known}, commit=False)
        wandb.log({'acc-novel':novel_cluster_results["acc"]}, commit=False)
        wandb.log({'nmi-novel':novel_cluster_results["nmi"]}, commit=False)
        wandb.log({'acc-all':all_cluster_results["acc"]}, commit=False)
