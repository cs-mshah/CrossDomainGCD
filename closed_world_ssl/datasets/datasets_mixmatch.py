...
def get_dataset224(args):
    ...
    # generate datasets
    train_labeled_dataset = GenericSSL(train_root, train_labeled_idxs, pseudo_idxs, pseudo_targets, transform=transform_labeled)
    train_unlabeled_dataset = GenericSSL(train_root, train_unlabeled_idxs, transform=TransformTwice(transform_labeled))
    train_pl_dataset = GenericSSL(train_root, train_unlabeled_idxs_, transform=transform_val)
